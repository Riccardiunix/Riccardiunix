...
setsid -f librewolf about:profiles https://addons.mozilla.org/en-US/firefox/addon/ff2mpv/ https://addons.mozilla.org/en-US/firefox/addon/darkreader/ https://addons.mozilla.org/en-US/firefox/addon/libredirect/ https://addons.mozilla.org/en-US/firefox/addon/skip-redirect/ https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/ https://addons.mozilla.org/en-US/firefox/addon/stack-overflow-prettifier/ https://addons.mozilla.org/en-US/firefox/addon/requestcontrol/ https://addons.mozilla.org/en-US/firefox/addon/behave https://addons.mozilla.org/en-US/firefox/addon/sidebery/ -P main > /dev/null 2>&1
